  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-bg px-4 text-center">
      ...
      <p className="max-w-xl text-text-muted">
        Build your ID, connect with people you've worked with, and get recognized for your skills and
        knowledge. Find venues, brands, events, jobs, and training relevant to you and your interests.
      </p>
